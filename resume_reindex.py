#!/usr/bin/env python3
"""Догрузка оставшихся записей в базу МДМ"""
import json
import os
import sys
...
print("Догрузка оставшихся записей", file=sys.stderr)
...
print(f"Осталось загрузить: {len(records)} записей", file=sys.stderr)
...
print(f"\n✅ Готово! Загружено: {total}, с эмбеддингами: {success}", file=sys.stderr)
